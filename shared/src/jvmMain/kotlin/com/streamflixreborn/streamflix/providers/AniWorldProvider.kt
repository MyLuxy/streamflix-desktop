...
import com.streamflixreborn.streamflix.utils.InMemoryTvShowCache
...
object AniWorldProvider : Provider {
    ...
    // no persistence across runs on desktop yet (Room doesn't run on plain JVM) - just an
    // in-memory cache for this process, and no background refresh worker (was WorkManager-only)
    private val tvShowDao = InMemoryTvShowCache()
    ...
    private fun getDao(): InMemoryTvShowCache = tvShowDao
