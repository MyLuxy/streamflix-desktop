    ...
    private suspend fun resolveMaxstreamUrl(url: String, isStayOnline: Boolean = false): String? {
        ...
        try {
            ...
            if (!b64Base.isNullOrBlank() && !b64Val.isNullOrBlank()) {
                val decodedBase = String(com.streamflixreborn.streamflix.utils.Base64.decode(b64Base, com.streamflixreborn.streamflix.utils.Base64.DEFAULT), Charsets.UTF_8)
                val decodedVal = String(com.streamflixreborn.streamflix.utils.Base64.decode(b64Val, com.streamflixreborn.streamflix.utils.Base64.DEFAULT), Charsets.UTF_8)
