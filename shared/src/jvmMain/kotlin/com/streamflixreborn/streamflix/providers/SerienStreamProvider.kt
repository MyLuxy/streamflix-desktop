...
object SerienStreamProvider : Provider {
    ...
    // no persistence across runs on desktop yet (Room doesn't run on plain JVM) - in-memory only
    private val tvShowDao = com.streamflixreborn.streamflix.utils.InMemoryTvShowCache()
