...
object AnikotoProvider : Provider {
    ...
    private fun parseCards(elements: List<Element>): List<ListItem> {
    ...
    private fun ListItem.itemId(): String = when (this) {
        is Movie -> id
        is TvShow -> id
        is Genre -> id
    ...
    private fun ListItem.matchesSearchQuery(query: String): Boolean {
        val title = when (this) {
            is Movie -> title
            is TvShow -> title
            else -> return true
