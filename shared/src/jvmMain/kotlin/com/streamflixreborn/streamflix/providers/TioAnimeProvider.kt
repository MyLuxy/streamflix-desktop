...
object TioAnimeProvider : Provider {
    ...
    private fun parseDirectory(document: Document, movieOverride: Boolean? = null): List<ListItem> =
    ...
    private fun parseHomeSection(document: Document, heading: String, movie: Boolean = false): List<ListItem> {
