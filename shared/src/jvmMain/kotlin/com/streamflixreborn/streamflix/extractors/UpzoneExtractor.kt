...
class UpzoneExtractor : Extractor() {
    ...
    override suspend fun extract(link: String): Video {
        val resolvedUrl = resolveRedirectWithWebView(link)
    ...
    private suspend fun resolveRedirectWithWebView(url: String): String =
        webViewResolver.resolveNavigation(
            url,
            headers = mapOf("Referer" to buildReferer(url), "User-Agent" to userAgent),
            matchSubstrings = emptyList(),
        )
