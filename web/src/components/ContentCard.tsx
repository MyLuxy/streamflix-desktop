...
export function ContentCard({
  ...
  const inner = (
    // shadow lives on this outer box, unclipped, so the hover glow can spread past the
    // card's edges the way it's meant to - overflow-hidden below only clips the poster/
    // content, never the box-shadow around the box it's set on
