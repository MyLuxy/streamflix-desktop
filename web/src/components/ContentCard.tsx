...
export function ContentCard({
  ...
  const className = inGrid
    ...
    : isLandscape
      ? "group relative flex-shrink-0 w-[220px] sm:w-[260px] md:w-[300px] cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-lg snap-start"
      : "group relative flex-shrink-0 w-[160px] sm:w-[180px] md:w-[220px] cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-lg snap-start";
