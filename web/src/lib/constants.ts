...
// local file so it cant itself fail to load, real tmdb logo, only for the api key setup sections
export const PROVIDER_LOGO_FALLBACK = "/provider-fallback.png";

// shown when a provider's own favicon 404s, deliberately not tmdb-branded
